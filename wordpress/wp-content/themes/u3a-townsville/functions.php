<?php
/**
 * KG Tyres Mechanical functions and definitions
 *
...
if ( ! function_exists( 'u3a_townsville_setup' ) ) :
	...
	define('KG_Tyres_Mechanical_FREE_THEME_DOC','https://www.kgthemesdemo.com/docs/free-u3a-townsville/');
	define('KG_Tyres_Mechanical_SUPPORT','https://wordpress.org/support/theme/u3a-townsville/');
	define('KG_Tyres_Mechanical_REVIEW','https://wordpress.org/support/theme/u3a-townsville/reviews');
	define('KG_Tyres_Mechanical_BUY_NOW','https://www.kgthemes.com/themes/wordpress-tyres-mechanical-theme/');
	define('KG_Tyres_Mechanical_LIVE_DEMO','http://www.kgthemesdemo.com/u3a-townsville-pro/');
	define('KG_Tyres_Mechanical_PRO_DOC','https://www.kgthemesdemo.com/docs/u3a-townsville-pro/');
	define('KG_Tyres_Mechanical_FAQ','https://www.kgthemes.com/faqs/');
	define('KG_Tyres_Mechanical_CONTACT','https://www.kgthemes.com/contact/');
	define('KG_Tyres_Mechanical_CHILD_THEME','https://developer.wordpress.org/themes/advanced-topics/child-themes/');
	define('KG_Tyres_Mechanical_CREDIT','https://www.kgthemes.com/themes/free-wordpress-tyres-mechanical/');
	
	if ( ! function_exists( 'u3a_townsville_credit' ) ) {
		function u3a_townsville_credit(){
			echo "<a href=".esc_url(U3A_TOWNSVILLE_CREDIT).">".esc_html__('U3A TOWNSVILLE WordPress Theme','u3a-townsville')."</a>";
		}
	}
