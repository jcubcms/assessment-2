            ...
            <div class="navigation">
              <?php
                  ...
                  the_posts_pagination( array(
                      'prev_text'          => __( 'Previous page', 'u3a_townsville' ),
                      'next_text'          => __( 'Next page', 'u3a_townsville' ),
                      'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'u3a_townsville' ) . ' </span>',
                  ) );
              ?>
