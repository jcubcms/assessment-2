...
function u3a_townsville_gettingstarted() {    	
	add_theme_page( esc_html__('About U3A_TOWNSVILLE', 'u3a-townsville'), esc_html__('About U3A_TOWNSVILLE', 'u3a-townsville'), 'edit_theme_options', 'u3a_townsville_guide', 'u3a_townsville_mostrar_guide');   
}
...
<div class="wrapper-info">
    <div class="col-left">
    	<h2><?php esc_html_e( 'Welcome to U3A_TOWNSVILLE Theme', 'u3a-townsville' ); ?> <span class="version">Version: <?php echo esc_html($theme['Version']);?></span></h2>
    ...
    <div class="col-right">
		...
		<div class="update-now">
			<h4><?php esc_html_e('Buy U3A_TOWNSVILLE at 20% Discount','u3a-townsville'); ?></h4>
			<h4><?php esc_html_e('Use Coupon','u3a-townsville'); ?> ( <span><?php esc_html_e('kgpro20','u3a-townsville'); ?></span> ) </h4> 
			<div class="info-link">
    ...
    <div class="tab-sec">
		...
		<div id="theme_lite" class="tabcontent open">
			...
			<hr class="h3hr">
		  	<p><?php esc_html_e('U3A_TOWNSVILLE is a theme of premium category and beneficial for different areas related to the IT sector like the IT solutions, software cleaning or junk removal. Being multipurpose to the core, you can make use of it for the infrastructure or renovation apart from interior cleaning of the computer or any digital repair. Being a premium category multipurpose theme, it finds applications in various industries like the carpenter works, electrician services or any other service related to plumbing. In case you are handling an automobile business or doing work related to the car garage services, you can go for U3A_TOWNSVILLE for a lifetime benefit in business. Because of its minimal characteristics and sophisticated looks, kg tyres mechanical is good for the servicing, installations and various businesses related to Tyres, Car and Mechanical. Because of its responsive and professional nature, it has the credit for creating the requisite elements as well as the pages for various websites related to the Tyres Mechanical. Being SEO friendly and accompanied with personalization options, it is highly suitable for creating a website related to the maintenance as well as repairing or cleaning services. It is user friendly and excellent for mechanical services as well.','u3a-townsville'); ?></p>
		...
		<div id="theme_pro" class="tabcontent">
		    ...
		    <div class="col-left-pro">
		    	...
		    	<div class="pro-links">
			    	<a href="<?php echo esc_url( U3A_TOWNSVILLELIVE_DEMO ); ?>" target="_blank"><?php esc_html_e('Live Demo', 'u3a-townsville'); ?></a>
					<a href="<?php echo esc_url( U3A_TOWNSVILLEBUY_NOW ); ?>"><?php esc_html_e('Buy Pro', 'u3a-townsville'); ?></a>
					<a href="<?php echo esc_url( U3A_TOWNSVILLEPRO_DOC ); ?>" target="_blank"><?php esc_html_e('Pro Documentation', 'u3a-townsville'); ?></a>
				</div>
		    </div>
