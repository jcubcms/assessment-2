...
function u3a_townsville_categorized_blog() {
	...
	if ( '1' != $u3a_townsville_all_the_cool_cats ) {
		// This blog has more than 1 category so u3a_townsville_categorized_blog should return true
		return true;
	} else {
		// This blog has only 1 category so u3a_townsville_categorized_blog should return false
		return false;
	}
}
...
/**
 * Flush out the transients used in u3a_townsville_categorized_blog
 */
