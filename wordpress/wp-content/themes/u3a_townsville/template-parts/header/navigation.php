				...
				<div class="row m-0">
					...
					<div class="col-lg-3 col-md-3 pr-0 col-8">
						<?php if( get_theme_mod( 'u3a_townsville_top_btn_url') != '' | get_theme_mod( 'u3a_townsville_top_btn_text') != '') { ?>
							<div class="top-btn">
								<a href="<?php echo esc_url(get_theme_mod('u3a_townsville_top_btn_url',''));?>"><?php echo esc_html(get_theme_mod('u3a_townsville_top_btn_text',''));?><span class="screen-reader-text"><?php esc_html_e( 'GET AN APPOINTMENT','u3a-townsville' );?></span></a>
							</div>
						<?php }?>
					</div>
				</div>
