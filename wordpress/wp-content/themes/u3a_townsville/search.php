...
<div class="container">
    <main id="maincontent" role="main" class="middle-align">
        <?php
            $theme_lay = get_theme_mod( 'u3a_townsville_theme_options','Right Sidebar');
            if($theme_lay == 'Left Sidebar'){ ?>
                <div class="row m-0">
                    <div class="col-lg-4 col-md-4" id="sidebar"><?php dynamic_sidebar('sidebar-1');?></div>
                    <div id="our-services" class="services col-lg-8 col-md-8">
                        <h1 class="entry-title"><?php 
                        printf( esc_html__( 'Results For: %s','u3a-townsville'), esc_html( get_search_query() ) ); ?></h1> 
                        <?php if ( have_posts() ) :
                        ...
                        <div class="navigation">
                            <?php
                                ...
                                the_posts_pagination( array(
                                    'prev_text'          => __( 'Previous page', 'u3a-townsville' ),
                                    'next_text'          => __( 'Next page', 'u3a-townsville' ),
                                    'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'u3a-townsville' ) . ' </span>',
                                ) );
                            ?>
